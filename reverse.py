...
listOfStr = ['450 g long grain white rice, preferably basmati','75 ml vegetable oil', '2 medium onions, chopped', '1 medium chicken or 700â€“900 g lamb on the bone cut in pieces', '570 ml water, plus 110 ml water', 'peel of 1 large orange', '50 g sugar',
...
dictOfWords = { i : list[i] for i in range(0, len(listOfStr) )}
